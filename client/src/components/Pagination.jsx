    ...
    return (
        <div className="pagination position">
            <div className="limits">
                ...
                <select name="limit" className="limit" value={itemsPerPage} onChange={handleItemsPerPageChange}>
            ...
            <p className="pages">{(currentPage - 1) * itemsPerPage + 1} - {Math.min(currentPage * itemsPerPage, totalItems)} of {totalItems}</p>
            <div className="actions">
                <button className="btn" title="First Page" onClick={handleFirstPage} disabled={currentPage === 1}>
                ...
                <button className="btn" title="Previous Page" onClick={handlePreviousPage} disabled={currentPage === 1}>
                ...
                <button className="btn" title="Next Page" onClick={handleNextPage} disabled={currentPage === totalPages}>
                ...
                <button className="btn" title="Last Page" onClick={handleLastPage} disabled={currentPage === totalPages}>
